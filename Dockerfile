...
LABEL author="feiyudev@gmail.com"
...
#    && apt update \
#    && apt install -y zsh curl wget git vim tree jq yq openssh-client nfs-common nfs-utils \
...
RUN apt install -y curl openssh-client nfs-common libnfs-utils
